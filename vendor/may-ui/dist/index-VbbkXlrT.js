...
import { h as z, w as N, m as S, B as G, z as D, u as X } from "./useSlidingThumb-5xXE6H74.js";
import { IoChevronDown as W, IoChevronForward as J, IoChevronBack as Q } from "react-icons/io5";
const V = ".may-kbd{display:inline-flex;align-items:center;justify-content:center;min-width:1.9em;padding-inline:var(--may-space-1);padding-block:.15em;border-radius:var(--may-radius-xs);background:var(--may-color-fill-tertiary);color:var(--may-color-text-secondary);font-family:var(--may-font-mono);font-variant-numeric:tabular-nums;font-weight:500;white-space:nowrap;box-shadow:var(--may-shadow-2xs);transition:transform var(--may-duration-settle) var(--may-spring-bouncy),background-color var(--may-duration-fast) var(--may-ease-out),color var(--may-duration-fast) var(--may-ease-out),box-shadow var(--may-duration-fast) var(--may-ease-out)}.may-kbd[data-pressed=true]{transform:translateY(1px) scale(.94);background:var(--may-color-fill);color:var(--may-color-text);box-shadow:none;transition:transform var(--may-duration-instant) var(--may-ease-out),background-color var(--may-duration-instant) var(--may-ease-out),box-shadow var(--may-duration-instant) var(--may-ease-out)}.may-kbd[data-size=xs]{font-size:var(--may-text-caption-2);line-height:var(--may-text-caption-2-leading)}.may-kbd[data-size=sm]{font-size:var(--may-text-caption-1);line-height:var(--may-text-caption-1-leading)}.may-kbd[data-size=md]{font-size:var(--may-text-footnote);line-height:var(--may-text-footnote-leading)}.may-kbd[data-size=lg]{font-size:var(--may-text-subheadline);line-height:var(--may-text-subheadline-leading)}", Z = {
  cmd: "⌘",
  command: "⌘",
  meta: "⌘",
  mod: "⌘",
...
//# sourceMappingURL=index-VbbkXlrT.js.map
